...
#else // !_WIN32
#define HID_TO_SMBUS_API ///<  HID to smbus api definition
#define WINAPI ///<  Windows api definition
#endif // !_WIN32
...
// HID_SMBUS_STATUS
#if defined(NOT_YET)
///@enum _HID_SMBUS_STATUS
///@brief HID SMBus status codes. Alias of this enum is HID_SMBUS_STATUS
...
///@typedef PHID_SMBUS_STATUS
///@brief HID SMBus status codes pointer
#else // defined(NOT_YET)
///@typedef HID_SMBUS_STATUS
///@brief HID SMBus status
...
///@typedef HID_SMBUS_S0
///@brief HID_SMBUS_TRANSFER_S0
...
///@typedef HID_SMBUS_S1
///@brief HID_SMBUS_TRANSFER_S1
...
// String Definitions
/////////////////////////////////////////////////////////////////////////////
///@enum _HID_SMBUS_GETSTRING
///@brief Product String Types. Alias of this enum is HID_SMBUS_GETSTRING.
///@details @ref HidSmbus_GetString() and @ref HidSmbus_GetOpenedString() options values
...
///@typedef PHID_SMBUS_GETSTRING
///@brief Product String Types pointer
_Check_return_
_Success_(return == TRUE)
__inline static _Bool IsValidHID_SMBUS_GETSTRING(_In_ const HID_SMBUS_GETSTRING _s) { return (HID_SMBUS_GET_VID_STR == _s) || (HID_SMBUS_GET_PID_STR == _s) || (HID_SMBUS_GET_PATH_STR == _s) || (HID_SMBUS_GET_SERIAL_STR == _s) || (HID_SMBUS_GET_MANUFACTURER_STR == _s) || (HID_SMBUS_GET_PRODUCT_STR == _s); }

// String Lengths
#define HID_SMBUS_DEVICE_STRLEN						260 ///< HID SMBus device string length

///@typedef HID_SMBUS_DEVICE_STR
///@brief HID_SMBUS_DEVICE_STR
...
/// @{
#define HID_SMBUS_MIN_BIT_RATE						1 ///< HID SMBus min bit rate
#define HID_SMBUS_MIN_TIMEOUT						0 ///< HID SMBus min timeout
#define HID_SMBUS_MAX_TIMEOUT						1000 ///< HID SMBus max timeout
#define HID_SMBUS_MAX_RETRIES						1000 ///< HID SMBus max retries
#define HID_SMBUS_MIN_ADDRESS						0x02 ///< HID SMBus min address
#define HID_SMBUS_MAX_ADDRESS						0xFE ///< HID SMBus max address
/// @}

// Read/Write Limits
/// @defgroup  ReadWriteLimits  Read/Write Limits definitions
/// @{
#define HID_SMBUS_MIN_READ_REQUEST_SIZE				1 ///< HID SMBus min read request size
#define HID_SMBUS_MAX_READ_REQUEST_SIZE				512 ///< HID SMBus max read request size
#define HID_SMBUS_MIN_TARGET_ADDRESS_SIZE			1 ///< HID SMBus min target address size
#define HID_SMBUS_MAX_TARGET_ADDRESS_SIZE			16 ///< HID SMBus max target address size
#define HID_SMBUS_MAX_READ_RESPONSE_SIZE			61 ///< HID SMBus max read response size
#define HID_SMBUS_MIN_WRITE_REQUEST_SIZE			1 ///< HID SMBus min write request size
#define HID_SMBUS_MAX_WRITE_REQUEST_SIZE			61 ///< HID SMBus max write request size
/// @}
...
/// @{
#define HID_SMBUS_DIRECTION_INPUT					0	///< HID SMBus direction input
#define HID_SMBUS_DIRECTION_OUTPUT					1	///< HID SMBus direction output
/// @}
...
/// @{
#define HID_SMBUS_MASK_GPIO_0						0x01 ///< HID SMBus mask gpio 0
#define HID_SMBUS_MASK_GPIO_1						0x02 ///< HID SMBus mask gpio 1
#define HID_SMBUS_MASK_GPIO_2						0x04 ///< HID SMBus mask gpio 2
#define HID_SMBUS_MASK_GPIO_3						0x08 ///< HID SMBus mask gpio 3
#define HID_SMBUS_MASK_GPIO_4						0x10 ///< HID SMBus mask gpio 4
#define HID_SMBUS_MASK_GPIO_5						0x20 ///< HID SMBus mask gpio 5
#define HID_SMBUS_MASK_GPIO_6						0x40 ///< HID SMBus mask gpio 6
#define HID_SMBUS_MASK_GPIO_7						0x80 ///< HID SMBus mask gpio 7
/// @}
...
///@typedef HID_SMBUS_PART_CP2112
///@brief CP2112 Part Numbers
#define HID_SMBUS_PART_CP2112						CP210x_PARTNUM_CP2112 ///< HID SMBus part number cp2112

/////////////////////////////////////////////////////////////////////////////
// User Customization Definitions
/////////////////////////////////////////////////////////////////////////////
///@enum _HID_SMBUS_LOCKBITS
//@brief  User-Customizable Field Lock Bitmasks
///@details @ref HidSmbus_SetLock() and @ref HidSmbus_GetLock() options values
...
///@typedef PHID_SMBUS_LOCKBITS
///@brief User-Customizable Field Lock Bitmasks pointer
_Check_return_
_Success_(return == TRUE)
__inline static _Bool IsValidHID_SMBUS_HID_SMBUS_LOCKBITS(_In_ const HID_SMBUS_LOCKBITS _s)
{
...
/// @{
#define HID_SMBUS_SET_IGNORE						0 ///< HID SMBus set ignore
#define HID_SMBUS_SET_PROGRAM						1 ///< HID SMBus set program
/// @}

// String Lengths
/// @defgroup CP2112StringLengths String Lengths definitions
/// @{
#define HID_SMBUS_CP2112_MFG_STRLEN					30 ///< HID SMBus CP2112 manufacturing string length
#define HID_SMBUS_CP2112_PRODUCT_STRLEN				30 ///< HID SMBus CP2112 product string length
#define HID_SMBUS_CP2112_SERIAL_STRLEN				30 ///< HID SMBus CP2112 serial string length
/// @}
///@typedef HID_SMBUS_CP2112_MFG_STR
///@brief  HID_SMBUS_MFG_STR
typedef char HID_SMBUS_CP2112_MFG_STR[HID_SMBUS_CP2112_MFG_STRLEN];
///@typedef HID_SMBUS_CP2112_PRODUCT_STR
///@brief  HID_SMBUS_PRODUCT_STR
typedef char HID_SMBUS_CP2112_PRODUCT_STR[HID_SMBUS_CP2112_PRODUCT_STRLEN];
///@typedef HID_SMBUS_CP2112_SERIAL_STR
///@brief  HID_SMBUS_SERIAL_STR
typedef char HID_SMBUS_CP2112_SERIAL_STR[HID_SMBUS_CP2112_SERIAL_STRLEN];

/////////////////////////////////////////////////////////////////////////////
// Typedefs
/////////////////////////////////////////////////////////////////////////////
///@typedef HID_SMBUS_DEVICE
///@brief  HID_SMBUS_DEVICE
...
///
/// @returns Returns #HID_SMBUS_SUCCESS on success, or another @ref HID_SMBUS_STATUSReturnCodes Return value if there is an error.
...
/// device path string, manufacturer string, or product string. See @ref _HID_SMBUS_GETSTRING "HID_SMBUS_GETSTRING"
///
...
/// @param[out] deviceReleaseNumber Points at a 2-byte buffer into which the USB device bcdVersion, or device release number, value will be written
///
...
///
/// @param[in] device is the Device object pointer as returned by @ref HidSmbus_Open().
/// @param[out] bIsOpened Points to a buffer into which a Boolean flag where TRUE means the device object pointer is valid and the device has been opened using @ref HidSmbus_Open(), and FALSE means it has not will be written
///
/// @returns Returns #HID_SMBUS_SUCCESS on success, or another @ref HID_SMBUS_STATUSReturnCodes Return value if there is an error.
///	@retval	#HID_SMBUS_SUCCESS -- success
///	@retval	#HID_SMBUS_INVALID_DEVICE_OBJECT -- device is not a valid, recognized Device object
...
/// and @ref HidSmbus_GetTransferStatusResponse() to check if the device has received data. Next, call HidSmbus_ForceReadResponse().
...
///
/// When status of @ref HID_SMBUS_S0_IDLE is returned, for detailedStatus see TBD.
...
/// @brief configures the GPIO pin's directions and modes.
///
/// @param[in]  device is an open handle to the device as returned by @ref HidSmbus_Open().
...
/// @brief returns the GPIO pin's directions and modes.
///
/// @param[in]  device is an open handle to the device as returned by @ref HidSmbus_Open().
...
///
/// @param[in]  device is an open handle to the device as returned by @ref HidSmbus_Open().
/// @param[in]  latchValue is the 1-byte output value to drive on GPIO pins configured as outputs. See @ref GPIOPinBitmask.
/// @param[in]  latchMask is the 1-byte bitmask specifying which bits to modify.
///
...
///
/// @returns Returns #HID_SMBUS_SUCCESS on success, another @ref HID_SMBUS_STATUSReturnCodes if there is an error:
...
/// @deprecated please use HidUart_GetHidGuidSafe()
///
/// @returns Returns #HID_SMBUS_SUCCESS on success, or another @ref HID_SMBUS_STATUSReturnCodes Return value if there is an error.
///	@retval	#HID_SMBUS_SUCCESS -- success
...
/// are already customized.  See @ref _HID_SMBUS_LOCKBITS "HID_SMBUS_LOCKBITS" and @ref FieldLockBitValues.
///
...
///
/// @param[in]  device is an open handle to the device as returned from @ref HidSmbus_Open()
/// @param[out] lock points at a 1-byte buffer into which the @ref _HID_SMBUS_LOCKBITS "HID_SMBUS_LOCKBITS" bitmask specifying which fields are locked will be copied and returned
///
/// @returns Returns #HID_SMBUS_SUCCESS on success, or another @ref HID_SMBUS_STATUSReturnCodes Return value if there is an error.
///	@retval	#HID_SMBUS_SUCCESS -- success
///	@retval	#HID_SMBUS_INVALID_PARAMETER -- lock was not specified, and/or is an unexpected value
...
///
/// @param[in]  device is an open handle to the device as returned by @ref HidSmbus_Open().
/// @param[out] vid Points to a 1-byte buffer into which the Vendor ID  is written and returned.
/// @param[out] pid Points to a 1-byte buffer into which the Product ID  is written and returned.
/// @param[out] power Points to a 1-byte buffer into which the power value which specifies the current requested by the device IFF the device is configured to be bus powered  is written and returned. See @ref HID_SMBUS_BUS_POWER_MAX.
/// @param[out] powerMode Points to a 1-byte buffer into which the Power Mode value to configure the device as bus powered or self powered  is written and returned. See @ref PowerModes.
/// @param[out] releaseVersion Points to a 1-byte buffer into which the Major.Minor Release Version value is written and returned.
///
/// @returns Returns #HID_SMBUS_SUCCESS on success, or another @ref HID_SMBUS_STATUSReturnCodes Return value if there is an error.
///	@retval	#HID_SMBUS_SUCCESS -- success
