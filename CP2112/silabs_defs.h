...
#ifndef _WIN32
#define UNREFERENCED_PARAMETER(p) (void)(p) ///< Unreferenced parameter definition
#endif
...
///@typedef PSILABS_VID
///@brief silabs vid pointer

///@brief check device is valid SILABS VID
///@param[in] _v SILABS VID value, type is @ref _SILABS_VID "SILABS_VID"
///@return true if device is valid SILABS VID, other is false.
_Check_return_
_Success_(return == TRUE)
__inline static _Bool IsValidSILABS_VID ( _In_ const SILABS_VID _v ) { return (SILABS_VID_10C4 == _v); }
...
///@typedef PSILABS_PID
///@brief silabs pid pointer

///@brief check device is valid SILABS PID 
///@param[in] _p SILABS PID value, type is @ref _SILABS_PID "SILABS_PID"
///@return true if device is valid SILABS PID, other is false.
_Check_return_
_Success_(return == TRUE)
__inline static _Bool IsValidSILABS_PID(_In_ const SILABS_PID _p) {
#ifdef _WIN32
#pragma warning ( push )
...
///@brief check device is valid CP210X PID 
///@param[in] _p SILABS PID value, type is @ref _SILABS_PID "SILABS_PID"
///@return true if device is valid CP210X PID, other is false.
_Check_return_
_Success_(return == TRUE)
__inline static _Bool IsValidCP210X_PID(_In_ const SILABS_PID _p) {
#ifdef _WIN32
#pragma warning ( push )
#pragma warning ( disable : 6287 ) // warning C6287: redundant code: the left and right sub-expressions are identical
#endif
...
///@enum _SILABS_PARTNUM_CPXXXX
///@brief Device Part Numbers
...
///@typedef PSILABS_PARTNUM_CPXXXX
///@brief Device Part Numbers pointer
#define CP210X_PARTNUM	SILABS_PARTNUM_CPXXXX	///< @deprecated, use @ref _SILABS_PARTNUM_CPXXXX "SILABS_PARTNUM_CPXXXX"
///@brief check device is valid cp210x partnum
///@param[in] _v partnumber value, type is @ref _SILABS_PARTNUM_CPXXXX "SILABS_PARTNUM_CPXXXX"
///@return true if is valid cp210x partnum, other is false.
_Check_return_
_Success_(return == TRUE)
__inline static _Bool IsValidCP210X_PARTNUM(_In_ const SILABS_PARTNUM_CPXXXX _v) {
...
///@brief check device is valid cp2102n partnum
///@param[in] _v partnumber value, type is @ref _SILABS_PARTNUM_CPXXXX "SILABS_PARTNUM_CPXXXX"
///@return true if is valid cp2102n partnum, other is false.
_Check_return_
_Success_(return == TRUE)
__inline static _Bool IsCP2102N_PARTNUM(_In_ const SILABS_PARTNUM_CPXXXX _v) {
	return ((CP210x_PARTNUM_CP2102N_QFN28 == _v) || (CP210x_PARTNUM_CP2102N_QFN24 == _v) || (CP210x_PARTNUM_CP2102N_QFN20 == _v));
}
///@brief check device is valid OTPCP210X partnum
///@param[in] _v partnumber value, type is @ref _SILABS_PARTNUM_CPXXXX "SILABS_PARTNUM_CPXXXX"
///@return true if is valid OTPCP210X partnum, other is false.
_Check_return_
_Success_(return == TRUE)
__inline static _Bool IsOTPCP210X_PARTNUM(_In_ const SILABS_PARTNUM_CPXXXX _v) {
	return ((CP210x_PARTNUM_CP2104 == _v) || (CP210x_PARTNUM_CP2105 == _v) || (CP210x_PARTNUM_CP2109 == _v));
}
///@brief check device is valid OTPCP210X partnum
///@param[in] _p product id value, type is @ref _SILABS_PID "SILABS_PID"
///@param[in] _v partnumber value, type is @ref _SILABS_PARTNUM_CPXXXX "SILABS_PARTNUM_CPXXXX"
///@return true if is valid OTPCP210X partnum, other is false.
_Check_return_
_Success_(return == TRUE)
__inline static _Bool IsOTP(_In_ const SILABS_PID _p, _In_ const SILABS_PARTNUM_CPXXXX _v) {
	return IsValidCP210X_PID(_p) ? IsOTPCP210X_PARTNUM(_v) : ((SILABS_PID_CP2110 == (SILABS_PID)_v) || (SILABS_PID_CP2112 == (SILABS_PID)_v) || (SILABS_PID_CP2114 == (SILABS_PID)_v) || (SILABS_PID_CP2130 == (SILABS_PID)_v));
}
///@brief check device can Write and Read Latch
///@param[in] _v partnumber value, type is @ref _SILABS_PARTNUM_CPXXXX "SILABS_PARTNUM_CPXXXX"
///@return true if can Write and Read Latch, other is false.
_Check_return_
_Success_(return == TRUE)
__inline static _Bool IsWriteReadLatchPartNum(_In_ const SILABS_PARTNUM_CPXXXX _v) {
...
///@brief check device is MultiInterface PartNum
///@param[in] _v partnumber value, type is @ref _SILABS_PARTNUM_CPXXXX "SILABS_PARTNUM_CPXXXX"
///@return true if device is MultiInterface PartNum, other is false.
_Check_return_
_Success_(return == TRUE)
__inline static _Bool IsMultiInterfacePartNum(_In_ const SILABS_PARTNUM_CPXXXX _v) {
...
///@typedef PSILABS_STATUS
///@brief API Status return codes pointer 
_Check_return_
_Success_(return == TRUE)
__inline static _Bool IsValidSILABS_STATUS(_In_ const SILABS_STATUS _s) {
...
_Check_return_
_Success_(return == TRUE)
__inline static _Bool IsSuccessSILABS_STATUS(_In_ const SILABS_STATUS _s) { return SILABS_STATUS_SUCCESS == _s; }
