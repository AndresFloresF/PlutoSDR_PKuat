...
CP210x_STATUS CCP2105Device::GetFirmwareVersion( pFirmware_t    lpVersion)
{
    CP210x_STATUS status = CP210x_INVALID_HANDLE;
    BYTE    setup[CP210x_MAX_SETUP_LENGTH];
