...
class transmitFM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "transmitFM")
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.iio_pluto_sink_0 = iio.pluto_sink('192.168.2.1', 115000000, 2084000, 20000000, 32768, False, 10.0, '', True)
...
def main(top_block_cls=transmitFM, options=None):
