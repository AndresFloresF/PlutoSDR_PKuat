...
class QPSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.variable_constellation_rect_0 = variable_constellation_rect_0 = digital.constellation_rect([-1-1j, -1+1j, 1+1j, 1-1j], [0, 1, 2, 3],
        8, 1, 1, 1, 1).base()
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(1,samp_rate,samp_rate/sps,.11,11*sps)
        self.NoiseSource = NoiseSource = 0

        ##################################################
        # Blocks
        ##################################################

        self._NoiseSource_range = Range(0, 1, .01, 0, 200)
        self._NoiseSource_win = RangeWidget(self._NoiseSource_range, self.set_NoiseSource, "'NoiseSource'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._NoiseSource_win)
        self.qtgui_time_sink_x_0_0 = qtgui.time_sink_c(
            2048, #size
            samp_rate, #samp_rate
            "Generacion de senal", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_0_0 = qtgui.freq_sink_c(
            ...
            0, #fc
            72000, #bw
            "Signal in frecuency domain", #name
            1,
            None # parent
        )
        ...
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(sps, 0.0628, rrc_taps, 100, 16, 1.5, 1)
        ...
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 100, 100000))), True)
        self.analog_noise_source_x_0 = analog.noise_source_c(analog.GR_GAUSSIAN, NoiseSource, 0)
        ...
        self.connect((self.blocks_add_xx_0_0, 0), (self.digital_pfb_clock_sync_xxx_0, 0))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_rrc_taps(firdes.root_raised_cosine(1,self.samp_rate,self.samp_rate/self.sps,.11,11*self.sps))
    ...
    def get_NoiseSource(self):
        return self.NoiseSource

    def set_NoiseSource(self, NoiseSource):
        self.NoiseSource = NoiseSource
        self.analog_noise_source_x_0.set_amplitude(self.NoiseSource)
