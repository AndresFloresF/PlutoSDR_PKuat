...
class EmpaquetadoDatos(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "EmpaquetadoDatos")
...
def main(top_block_cls=EmpaquetadoDatos, options=None):
