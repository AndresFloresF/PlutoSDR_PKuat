...
class GeneradorFunciones(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "GeneradorFunciones")
...
def main(top_block_cls=GeneradorFunciones, options=None):
